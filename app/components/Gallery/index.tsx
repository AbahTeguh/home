            ...
            <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8 mt-20 md:pt-24'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-12 my-16 sm:space-x-6 space-y-6 md:space-y-0 px-6'>
                    ...
                    <div className='col-span-6 flex justify-center overflow-hidden rounded-3xl'>
                        <Image src="/home/images/Gallery/foodone.jpg" alt="pizza-one" width={1000} height={805} className="inner-img"/>
                    </div>

                    <div className='col-span-6 flex justify-center'>
                        <div className="grid grid-rows-1 grid-flow-row gap-4">
                            <div className="row-span-1 overflow-hidden rounded-3xl">
                                <Image src="/home/images/Gallery/foodtwo.jpg" alt="pizza-two" width={700} height={405} className="inner-img"/>
                            </div>
                            <div className='grid grid-cols-2 gap-2'>
                                <div className='overflow-hidden rounded-3xl'>
                                    <Image src="/home/images/Gallery/foodthree.jpg" alt="pizza-three" width={500} height={405} className="inner-img"/>
                                </div>
                                <div className='overflow-hidden rounded-3xl'>
                                    <Image src="/home/images/Gallery/foodfour.jpg" alt="pizza-four" width={500} height={405} className="inner-img"/>
                                </div>
                            </div>
                        </div>
                    </div>
